    ...
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div class="title-wrap">
          ...
          <div class="app-sub" id="subTitle">Loading…</div>
        </div>
      </div>
    ...
    <div id="modalOverlay" class="modal-overlay hidden" aria-hidden="true">
      <div class="modal" role="dialog" aria-modal="true" aria-labelledby="modalTitle">
        ...
        <div class="modal-body">
          ...
          <label class="field">
            <span>Notes</span>
            <textarea id="editNotes" rows="3" placeholder="Optional…"></textarea>
          </label>
        </div>
    ...
    <div id="planImportOverlay" class="modal-overlay hidden" aria-hidden="true">
      <div class="modal" style="max-width:900px;">
        <div class="modal-header">
          ...
          <button class="icon-btn" id="planImportCloseBtn" aria-label="Close">✕</button>
        </div>
        <div class="modal-body">
    ...
    <div id="planGenerateOverlay" class="modal-overlay hidden" aria-hidden="true">
      <div class="modal" style="max-width:760px;">
        <div class="modal-header">
          ...
          <button class="icon-btn" id="planGenerateCloseBtn" aria-label="Close">✕</button>
        </div>
        <div class="modal-body">
          <div class="row">
